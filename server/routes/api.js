...
const allBlogs = require("../../models/blog-model");
const teamMembers = require("../../models/team-model");
const work = require("../../models/work-model");
const contactus = require("../../models/contact-us");
const signUp = require("../../models/signup-model");
const dailyTask = require("../../models/daily-task");
...
mongoose.connect('mongodb+srv://anshul:anshul21@shoppingportal-mdtac.mongodb.net/test?ssl=true&retryWrites=true&w=majority',
                { useUnifiedTopology: true, useCreateIndex: true, useNewUrlParser: true, dbName: 'rayqube' }, (err, rayqube) => {
